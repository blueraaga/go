...
sudo wget --no-verbose --timestamping https://dl.google.com/go/go1.12.7.linux-amd64.tar.gz 

mkdir -p go1.12.7
sudo tar --extract --skip-old-files --file /vagrant/resources/apps/go1.12.7.linux-amd64.tar.gz -C ./go1.12.7
...
sudo ln --symbolic --force /vagrant/resources/apps/go1.12.7/go /usr/local/go
